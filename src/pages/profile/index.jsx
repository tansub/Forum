        ...
        <div className="containerProfile">
            <div className="profile">
                <div className="left">
                    ...
                    <div className='info'>
                        <div><span className='boldText'>Имя: </span> {data?.username}</div>
                        <div><span className='boldText'>ID волонтера: </span>{data?.id} </div>
                        <div className="infoPics">
                            <div>
                                <img src="https://dobro.ru/_next/static/media/gift.464633f3.svg" alt="" />
                                <span className='boldText'> Дата рождения: </span>{data?.birth_date} 
                            </div>
                            <div>
                                <img src="https://dobro.ru/_next/static/media/location.42966452.svg" alt="" />
                                <span className='boldText'>Местоположение: </span> {data?.city}  
                            </div>
                        </div>
                    </div>
                </div>
